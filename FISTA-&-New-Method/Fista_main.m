...
%Angle increment between views (unit:degree)
    ...
    % Define b as a function b(y,L)= y - 1/L*(grad_f(y)) 
        ...
        for i = 1:maxIter
           ...
           t = t_next;
           y = y_next;
        [costs(j,i),misfits(j,i),reg1s(j,i)] = Objective2(A,x,data_new,gamma1);
        ...
        tit = [num2str(nviews(j)),'views reconstruction - \gamma = ',num2str(gamma1)];
        title(tit);
...
title('Convergence History FISTA');
legend('540','270','90');
